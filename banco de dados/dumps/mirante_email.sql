...
CREATE TABLE `email` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKmv73jqkep03fr08gsysyrdp6u` (`cliente_id`),
  CONSTRAINT `FKmv73jqkep03fr08gsysyrdp6u` FOREIGN KEY (`cliente_id`) REFERENCES `cliente` (`id`)
...
-- Dump completed on 2019-12-17 20:24:55
