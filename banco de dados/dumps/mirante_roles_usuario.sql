...
CREATE TABLE `roles_usuario` (
  ...
  KEY `FKqm15n15x6x9fb5a7wrql1d8vn` (`id_role`),
  CONSTRAINT `FKkkywkwuyhd3ia5v8lbypmiv44` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `FKqm15n15x6x9fb5a7wrql1d8vn` FOREIGN KEY (`id_role`) REFERENCES `roles` (`id`)
...
-- Dump completed on 2019-12-17 20:24:52
